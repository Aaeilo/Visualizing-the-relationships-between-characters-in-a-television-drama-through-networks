...
var simulation = d3.forceSimulation()
    ...
    .force("collide",d3.forceCollide( function(d){return 70}).iterations(1))
...
d3.selectAll("input[name=sentiment]").on("change", function() {
  function getCheckedBoxes(chkboxName) {
    ...
    var checkedBoxes = getCheckedBoxes("sentiment");
    
      path.style("opacity", 1);

      path.filter(function(d) {
          return checkedBoxes.indexOf(d.value) === -1 && 
          checkedBoxes.indexOf(d.value) === -1;
        })
        .style("opacity", "0.2");
